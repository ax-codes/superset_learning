...
SQLALCHEMY_DATABASE_URI = "mysql://root:root@127.0.0.1:3306/superset"
...
ENABLE_TIME_ROTATE = False  # 启用时间轮换
...
# 是否在 flask_appbuilder 包上将日志级别提升为 ERROR
# 如果/在调试 FAB 相关问题时设置为 False，例如
# 权限管理
SILENCE_FAB = True
