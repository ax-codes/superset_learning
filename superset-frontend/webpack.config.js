...
const config = {
  entry: {
    preamble: PREAMBLE,
    theme: path.join(APP_DIR, '/src/theme.ts'), //主题
    menu: addPreamble('src/views/menu.tsx'), //menu
    spa: addPreamble('/src/views/index.tsx'), //views
    embedded: addPreamble('/src/embedded/index.tsx'), //嵌入
    addSlice: addPreamble('/src/addSlice/index.tsx'), //切片
    explore: addPreamble('/src/explore/index.jsx'),
    sqllab: addPreamble('/src/SqlLab/index.tsx'),
    profile: addPreamble('/src/profile/index.tsx'), //轮廓
